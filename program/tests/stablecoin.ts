...
describe("stablecoin", () => {
  ...
  it("Is initialized!", async () => {
    ...
    console.log(" initialized config account: ", tx);
  });
  ...
  it("deposits collateral and mints usdc", async () => {
    ...
    console.log("deposits collateral and mints usdc: ", tx);
  });
  ...
  it("redeems collateral and burns tokens", async () => {
    ...
    console.log("redeems collateral  and burns mint", tx);
  });
