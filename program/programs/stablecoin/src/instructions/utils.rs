...
use crate::{constants::{MAXIMUM_AGE, PRICE_FEED_DECIMAL_ADJUSTMENT}, error::CustomError, Collateral, Config, FEED_ID};


pub fn check_health_factor(collateral: &Account< Collateral>,
    config: &Account< Config>,
    price_feed: &Account<PriceUpdateV2>) -> Result<()> {
